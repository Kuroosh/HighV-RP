...
namespace Altv_Roleplay.models
{
    public partial class gtaContext : DbContext
    {
        ...
        public virtual DbSet<Server_Clothes> Server_Clothes { get; set; }
        ...
        public virtual DbSet<Server_Clothes_Storages> Server_Clothes_Storages { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Characters_Skin>(entity =>
            {
                ...
                entity.Property(e => e.clothesTop).HasColumnName("clothesTop");
                entity.Property(e => e.clothesTorso).HasColumnName("clothesTorso");
                entity.Property(e => e.clothesLeg).HasColumnName("clothesLeg");
                entity.Property(e => e.clothesFeet).HasColumnName("clothesFeet");
                entity.Property(e => e.clothesHat).HasColumnName("clothesHat");
                entity.Property(e => e.clothesGlass).HasColumnName("clothesGlass");
                entity.Property(e => e.clothesEarring).HasColumnName("clothesEarring");
                entity.Property(e => e.clothesNecklace).HasColumnName("clothesNecklace");
                entity.Property(e => e.clothesMask).HasColumnName("clothesMask");
                entity.Property(e => e.clothesArmor).HasColumnName("clothesArmor");
                entity.Property(e => e.clothesUndershirt).HasColumnName("clothesUndershirt");
                entity.Property(e => e.clothesBracelet).HasColumnName("clothesBracelet");
                entity.Property(e => e.clothesWatch).HasColumnName("clothesWatch");
                entity.Property(e => e.clothesBag).HasColumnName("clothesBag");
                entity.Property(e => e.clothesDecal).HasColumnName("clothesDecal");
            });
            ...
            modelBuilder.Entity<Server_Clothes>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_clothes", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.clothesName).HasColumnName("clothesName").HasMaxLength(128);
                entity.Property(e => e.type).HasColumnName("type").HasMaxLength(64);
                entity.Property(e => e.draw).HasColumnName("draw").HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Server_Clothes_Storages>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_clothes_storages", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id).HasName("id");
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.posX).HasColumnName("posX");
                entity.Property(e => e.posY).HasColumnName("posY");
