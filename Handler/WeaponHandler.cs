                ...
                if (type == "Weapon")
                {
                    if (wType == "Primary")
                    {
                        ...
                        else if (primWeapon == wName)
                        {
                            ...
                            {
                                if (invWeight + multiWeight <= 15f) { CharactersInventory.AddCharacterItem(charId, $"{ammoWName} Munition", wAmmoAmount, "inventory"); inBackpack = false; } else { inBackpack = true; }
                                if (backpackWeight + multiWeight <= Characters.GetCharacterBackpackSize(Characters.GetCharacterBackpack(charId)) && inBackpack == true) { CharactersInventory.AddCharacterItem(charId, $"{ammoWName} Munition", wAmmoAmount, "backpack"); }
                            }
                    ...
                    else if (wType == "Secondary")
                    {
                        ...
                        if (secondaryWeapon == "None")
                        {
                            if (secondaryWeapon2 == wName)
                            {
                                ...
                                {
                                    if (invWeight + multiWeight <= 15f) { CharactersInventory.AddCharacterItem(charId, $"{ammoWName} Munition", ammoAmount, "inventory"); inBackpack = false; } else { inBackpack = true; }
                                    if (backpackWeight + multiWeight <= Characters.GetCharacterBackpackSize(Characters.GetCharacterBackpack(charId)) && inBackpack == true) { CharactersInventory.AddCharacterItem(charId, $"{ammoWName} Munition", ammoAmount, "backpack"); }
                                }
